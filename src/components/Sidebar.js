...
const Sidebar = ({ isOpen, setHeaderTitle }) => {
  ...
  return (
    <div className={`sidebar ${isOpen ? 'open' : ''}`}>
      <div className={myState === "/TextDiffViewer" ? "sidebar-item click-item" : "sidebar-item"}
      ...
      <div className={myState === "/ClipboardMonitor" ? "sidebar-item click-item" : "sidebar-item"}
      ...
      <div className={myState === "/BookMark" ? "sidebar-item click-item" : "sidebar-item"}
